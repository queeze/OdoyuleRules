...
namespace OdoyuleRules.Tests.ConditionTests
{
    ...
    public class Conditions_using_less_than_or_equal
    {
        ...
        {
            var left = Conditions.LessThanOrEqual((Order o) => o.Amount, 123.45m);
            var right = Conditions.LessThanOrEqual((Order o) => o.Amount, 123.45m);
        ...
        public void Should_be_idempotent()
        {
            ...
            conditions.Add(Conditions.LessThanOrEqual((Order o) => o.Amount, 123.45m));
            conditions.Add(Conditions.LessThanOrEqual((Order o) => o.Amount, 123.45m));
