...
namespace OdoyuleRules.Tests.ConditionTests
{
    ...
    public class Conditions_using_less_than
    {
        ...
        {
            var left = Conditions.LessThan((Order o) => o.Amount, 123.45m);
            var right = Conditions.LessThan((Order o) => o.Amount, 123.45m);
        ...
        public void Should_be_idempotent()
        {
            ...
            conditions.Add(Conditions.LessThan((Order o) => o.Amount, 123.45m));
            conditions.Add(Conditions.LessThan((Order o) => o.Amount, 123.45m));
