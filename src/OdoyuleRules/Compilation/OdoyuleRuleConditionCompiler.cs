...
namespace OdoyuleRules.Compilation
{
        ...
        RuleConditionCompiler
    {
        ...
        public OdoyuleRuleConditionCompiler(RuntimeConfigurator configurator)
        {
        ...
        public override bool Visit<T, TProperty>(PropertyNotEqualCondition<T, TProperty> condition, Func<SemanticModelVisitor, bool> next)
        {
            RunNodeSelector(condition.PropertyExpression,
